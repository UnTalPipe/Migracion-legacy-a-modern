...
public OnPlayerCommandText(playerid, cmdtext[]) {
        ...
        if (!strcmp("/laseron", cmdtext, true)) {
                ...
                SendClientMessage(playerid, 0x00E800FF, "[INFO]: Laser Activado! Cambia el color con '/lasercol [Color]' o Desactivalo con '/laseroff'!");
                return 1;
        }
        ...
        if (!strcmp("/laseroff", cmdtext, true)) {
                SetPVarInt(playerid, "laser", 0);
                RemovePlayerAttachedObject(playerid, 0);
                SendClientMessage(playerid, 0x00E800FF, "[INFO]: Laser Desactivado! Vuelve a Activalo con '/laseron'!");
                return 1;
        }
        ...
        if (!strcmp("/lasercol", cmd, true)) {
                ...
                if (!strlen(tmp)) {
                        SendClientMessage(playerid, 0xFF0000FF, "[USO]: /lasercol [color]") &&
						SendClientMessage(playerid, 0x00E800FF, "[Colores]: Rojo, Azul, Rosa, Naranja, Verde, Amarillo");
                        return 1;
                }
                ...
                else SendClientMessage(playerid, 0xFF0000FF, "[ERROR]: {FFFFFF}Ese color no esta en la lista!");
                return 1;
        }
